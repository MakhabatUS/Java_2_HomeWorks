...
public class Dictionary {
    ...
    public static void main(String[] args) {
        ...
        bigDictionary(dictionary, bigDictionary);
    ...
    private static void bigDictionary(HashMap<String, String[]> dictionary, HashMap<String, String[]> bigDictionary) {
